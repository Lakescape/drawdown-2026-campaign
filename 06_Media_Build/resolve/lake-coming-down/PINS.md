# DRAWDOWN_LakeComingDown_916_STUDIO — pins
...
|---|---|---|---|---|---|
| 0 | 0.00 | 5.60 | clip 015 in=3.0s | LAKE AUSTIN. OCT 12. | PASS · real drone, cove + boathouse, letterboxed over blur · strap clear of picture |
| 1 | 5.25 | 5.60 | clip 018 in=8.0s | ABOUT 10 FEET. A FOOT A DAY. LCRA. | PASS · clip 018 t=8, cove edge with a weed mat, no house — swapped in 2026-09-06 on Victoria's call (the recognisable residence in 009 t=30 is out) |
| 2 | 10.50 | 5.60 | clip 014 in=15.0s | THIS IS UNDER IT. HYDRILLA · NEARLY TEN YEARS | PASS · dense hydrilla mat at a cove edge, real aerial · reads as weed without the subline |
| 3 | 15.75 | 5.60 | clip 011 in=40.0s | SCRAPE. HAUL. COVER. WHILE IT'S DOWN | PASS · boathouse cove, no machine, no count word · verbs match the method cut |

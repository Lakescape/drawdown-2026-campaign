...
SLOTS = [
    ...
    ("2026-09-23", "Wed", "IG Reels · TikTok", "video", "DRAWDOWN_ViralHydrilla_916_STUDIO_CLAUDE_VO_MikeRow.mp4",
     "Lead-in rerun",
     "Ten years under water. Oct 12 it comes up for air.\n\nAbout 10 feet, seven weeks, then it's gone.\n\n" + CTA),
    ...
    ("2026-09-30", "Wed", "IG Reels · TikTok", "video", "DRAWDOWN_LakeComingDown_916_STUDIO_LakeComingDown_v1.mp4",
